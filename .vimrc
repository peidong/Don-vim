...
if g:peivim_bundle_level >= 2
    ...
    if g:peivim_bundle_level >= 3
        ...
        if executable('ctags') && has('patch-7.0.167')
    ...
    if g:peivim_complete_engine == 5 && !(has('patch-7.3.598') && executable('python') && has('python'))
        let g:peivim_complete_engine = 3
    endif

    if g:peivim_complete_engine == 4 && !(has('lua') && has('patch-7.3.885'))
        let g:peivim_complete_engine = 3
    endif

    if g:peivim_complete_engine == 3 && has('lua') && has('patch-7.3.885') && (!WINDOWS())
